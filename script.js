...
const state = {
  ...
  authMode: 'login',
  balance: 2450,
  user: { name: 'Guest', email: 'guest@nawashop.com', avatar: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&w=120&q=80' },
  cart: [
...
function renderAuthState() {
  ...
  profileEmail.textContent = state.user.email || 'member@nawashop.com';
